# ChallangeJava2
Trabalho solicitado:
O arquivo de log deve ser lido e algumas estatísticas devem ser coletadas, conforme indicado abaixo:

		• Tarefa 1: Contar e mostrar o número de visitas distintas. Uma visita distinta é o conjunto de 
		todos os
	...
	acessar o servidor web, classificados em ordem decrescente de ocorrência.
		...
		• Tarefa 3: Conheça os três maiores períodos de tempo sem acesso ao servidor web. Mostrar os períodos em
...
terminar rapidamente. Você pode usar as seguintes classes Java para extrair e analisar as informações
